...
pub type BLST_ERROR = ::std::os::raw::c_uint;
pub type byte = u8;
pub type limb_t = u64;
#[repr(C)]
...
fn bindgen_test_layout_blst_scalar() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_scalar>())).b as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_blst_fp6() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_fp6>())).fp2 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_blst_fp12() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_fp12>())).fp6 as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn blst_fr_lshift(ret: *mut blst_fr, a: *const blst_fr, count: size_t);
}
extern "C" {
    pub fn blst_fr_rshift(ret: *mut blst_fr, a: *const blst_fr, count: size_t);
}
extern "C" {
...
extern "C" {
    pub fn blst_fp_lshift(ret: *mut blst_fp, a: *const blst_fp, count: size_t);
}
extern "C" {
...
fn bindgen_test_layout_blst_p1_affine() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_p1_affine>())).x as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_p1_affine>())).y as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_blst_p2_affine() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_p2_affine>())).x as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<blst_p2_affine>())).y as *const _ as usize
        },
        96usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    pub fn blst_p1s_mult_wbits_scratch_sizeof(npoints: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn blst_p1s_mult_pippenger_scratch_sizeof(npoints: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn blst_p2s_mult_wbits_scratch_sizeof(npoints: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn blst_p2s_mult_pippenger_scratch_sizeof(npoints: size_t) -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn blst_pairing_sizeof() -> size_t;
}
extern "C" {
...
extern "C" {
    pub fn blst_uniq_sizeof(n_nodes: size_t) -> size_t;
}
extern "C" {
